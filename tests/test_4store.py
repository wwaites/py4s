...
class TestClass:
	...
	def test_10_add_triple(self):
		...
		assert count == 3
	def test_11_triples(self):
		triple, = list(store.triples((None, RDF.type, None)))
		assert triple == (URIRef("http://irl.styx.org/foo"), RDF.type, URIRef("http://irl.styx.org/Thing"))
